...
## Does the guardrail for the maximum number of computed attributes per sandbox in Adobe Experience Platform include only enabled and processing Computed Attributes or also disabled Computed Attributes?
